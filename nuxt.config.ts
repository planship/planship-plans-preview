...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      clientPlanshipBaseUrl: process.env.PLANSHIP_API_CLIENT_URL || 'https://api.planship.io',
      serverPlanshipBaseUrl: process.env.PLANSHIP_API_SERVER_URL || 'https://api.planship.io',
